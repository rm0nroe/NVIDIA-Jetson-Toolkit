...
rsync -avz patches_orin_nano_jp62/driver/ jetson:~/imx708-driver/
```
...
# On Jetson
git clone https://github.com/RidgeRun/NVIDIA-Jetson-IMX708-RPIV3.git
cd NVIDIA-Jetson-IMX708-RPIV3/patches_orin_nano_jp62/driver
```
...
Use the overlay source in `docs/jp-6.2/overlays/imx708-nvidia-csi.dts`:
...
| Overlay source | `docs/jp-6.2/overlays/imx708-nvidia-csi.dts` | Overlay DTS |
